...
import Simple_Flex_Items from "@/components/widget_components/simple_flex_items";
...
${appName} lets you buy airtime for all major Nigerian networks, MTN, Airtel, Glo, and 9mobile in seconds, straight from your wallet. Enjoy 2%
